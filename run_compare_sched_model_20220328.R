...

{
  ...
  wtis_in <- paste0(base_dir,"/OPTIMISE_09-27-2021/SK Waitlist 03 24 2022_sub2.xlsx")
  turnover_buffer <- 25
}
...
spreadsheets[[1]]$day_df %>% as_tibble() %>% readr::write_csv(paste0(base_dir,"/april_2021_baseline_day_df_20220121.csv"))
spreadsheets[[2]]$day_df %>% as_tibble() %>% readr::write_csv(paste0(base_dir,"/april_2021_3addedblocks_day_df_20220121.csv"))
# spreadsheets[[3]]$day_df %>% as_tibble()  %>% readr::write_csv(paste0(base_dir,"/jan_2022_added_blocks_day_df_no_sched_20220121.csv"))
spreadsheets[[3]]$day_df %>% as_tibble() %>% readr::write_csv(paste0(base_dir,"/april_2021_3addedblocks_9.5hr_20220121.csv"))
spreadsheets[[4]]$day_df %>% as_tibble() %>% readr::write_csv(paste0(base_dir,"/april_2021_6addedblocks_9.5hr_day_df_20220121.csv"))
